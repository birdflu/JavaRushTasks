...
public class StatisticManager {
  ...
  private static class StatisticStorage {
...

    {
      ...
      List<Dish> dishes1 = new ArrayList() {{ add(Dish.Soup); }};
      List<Dish> dishes2 = new ArrayList() {{ add(Dish.Soup); add(Dish.Steak);  }};
      List<Dish> dishes3 = new ArrayList() {{ add(Dish.Water); add(Dish.Juice); add(Dish.Fish); }};
    ...
    private int getTotalCookingTime(List<Dish> dishes) {
